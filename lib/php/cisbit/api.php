...
';           
  ...
  private function load_google()
    ...
    $_SESSION['client_google']->setClientId('733647027412.apps.googleusercontent.com');
    $_SESSION['client_google']->setClientSecret('ak4wUbW-oQHMObo3OEXltcm_');
    $_SESSION['client_google']->setRedirectUri('http://cisbit.com/api/');
