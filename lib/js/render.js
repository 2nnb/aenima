var Render = Class.extend(
     ...
     init: function(app) 
        ...
        var self = this;
        self.app = app;        
        $('body').append("<div id='"+self.app.name+"' ></div>");
     ...
     load_view: function(view_src, view, data)
        {
        var self = this;          
        var src = $("#"+view_src+"_src").html();
        $('#'+self.app.name).append("<div id='"+view+"'></script>");
        var compiled = Handlebars.compile(src);  
        $("#"+view).html(compiled({"data":data})); 
        },
     load_isotope_main: function()
        {
	var $container = $('#container');
	$select = $('#main_options select');
	$container.imagesLoaded( function()
           {
            ...
            var $optionSets = $('#main_options .option-set'),
